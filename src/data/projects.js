    ...
    modelos3d: [
      {
        ...
        description: 'Chaqueta con cruce, solapas en pico y falda de vuelo con estampado degradado. Tela exterior en lino y forro de seda..',
        accent: '#8a1a1a',
      ...
      },
      {
        ...
        description: 'Blusa con cuello vuelto con cierre de cremallera por el delantero. Falda de con pliegues. El forro tiene estampado de flores.',
        accent: '#6b1020',
      ...
      },
      {
        ...
        description: 'Vestido largo con cinturilla y costados de color rojo, acompañado de una capa de voile asimétrica con frunce en un lado.',
        accent: '#b02020',
      ...
      },
      {
        ...
        description: 'Vestido con patrones triangulares con estampado creado con procreate, acompañado de una banda roja de organza.',
        accent: '#4a5e30',
      ...
      },
      {
        ...
        description: 'Vestido con escote drapeado y corte canesú en la falda. El cierre de la espalda es con cremallera invisible.',
        accent: '#3a5228',
